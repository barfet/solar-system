...
var DEV_PROTOCOL = 'http://';
var DEV_HOST = 'home.solar.system';
var DEV_PORT = 5000;
var SITE_ROOT = '/';
...
module.exports = function makeWebpackConfig() {
  ...
  config.output = isTest ? {} : {
    path: root('dist'),
    publicPath: isProd ? SITE_ROOT : (DEV_PROTOCOL + DEV_HOST + ':' + DEV_PORT + '/'),
