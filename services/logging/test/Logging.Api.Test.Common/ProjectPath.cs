...
namespace Logging.Api.Test.Common
{
    public static class ProjectPath
    {
        private const string SolutionName = "Logging.Api.sln";

        public static string LogMessagesPath = GetSolutionFilePath() + "/LogMessageSamples/";
